...
- OpenWeather API key from https://openweathermap.org/ (free tier is generous)
...
5. Copy files to your Pi (if developing on a separate computer), e.g. via scp e.g. `scp -r ./your-folder-name pi@<pi-ip>:/home/pi/` replacing with your Pi's host etc.
